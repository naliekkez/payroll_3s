          	...
          	<div class="modal-body">
            	<form class="form-horizontal" method="POST" action="attendance_add.php">
          		  <div class="form-group ">
                  	...
                  	<div class="col-sm-9 auto-widget">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select type="text" class="form-control" id="status" name="status"  required>
                          ...
                          <option val="MASUK"> MASUK </option>
                          <option val="IZIN"> IZIN </option>
                          <option val="SAKIT"> SAKIT </option>
                          <option val="ALPHA"> ALPHA </option>
                          <option val="HARI LIBUR"> HARI LIBUR </option>
                          <option val="OVERTIME"> OVERTIME </option>
                          <option val="TELAT"> TELAT </option>
                      </select>
                    </div>
                </div>
          	</div>
        ...
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <select type="text" class="form-control" id="edit_status" name="status"  required>
                          <option val=""> -- Select -- </option>
                          <option val="MASUK"> MASUK </option>
                          <option val="IZIN"> IZIN </option>
                          <option val="SAKIT"> SAKIT </option>
