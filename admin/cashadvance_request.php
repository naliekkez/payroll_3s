              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    $sql = "SELECT *, employees.employee_id AS empid, exchange.id AS attid FROM employees,exchange,position where employees.id=exchange.employee_id AND (exchange.branch_request_id = '$branch' OR '0' = '$branch') AND position.id = exchange.position_id ORDER BY exchange.date DESC, exchange.time_in DESC ";
