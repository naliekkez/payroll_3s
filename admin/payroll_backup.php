              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    $sql = "SELECT *, count(*) AS total_day, attendance.employee_id AS empid FROM attendance,position, employees WHERE employees.id=attendance.employee_id AND position.id=employees.position_id AND date BETWEEN '$from' AND '$to' AND (employees.branch_id = '$branch' or '0' = '$branch')  GROUP BY attendance.employee_id ORDER BY employees.lastname ASC, employees.firstname ASC";
