                      ...
                      echo "
                        <tr>
                          ...
                          <td>
                            ...
                            <button class='btn btn-success btn-sm btn-flat approve' data-id='".$row['cid']."'><i class='fa fa-edit'></i> Approve</button>
                            <button class='btn btn-danger btn-sm btn-flat reject' data-id='".$row['cid']."'><i class='fa fa-trash'></i> Reject</button>
