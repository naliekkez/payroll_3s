<?php
	...
	$sql = "SELECT *, count(*) AS total_day, attendance.employee_id AS empid, employees.employee_id AS employee FROM attendance,position,employees WHERE employees.id=attendance.employee_id  AND position.id=employees.position_id AND date BETWEEN '$from' AND '$to'  AND (employees.branch_id = '$branch' or '0' = '$branch') GROUP BY attendance.employee_id ORDER BY employees.lastname ASC, employees.firstname ASC";
			...
			<table cellspacing="0" cellpadding="3">  
    	    	...
    	    	<tr>
    	    		<td width="25%" align="right">Employee ID: </td>
				 	...
				 	<td width="25%" align="right">'.number_format($row['total_day'], 2).'</td> 
    	    	</tr>
    	    	<tr> 
    	    		<td></td> 
    	    		<td></td>
				 	<td width="25%" align="right"><b>Gross Pay: </b></td>
				 	<td width="25%" align="right"><b>'.number_format(($row['rate']*$row['total_day']), 2).'</b></td> 
    	    	</tr>
    	    	<tr> 
    	    		<td></td> 
    	    		<td></td>
