              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    $sql = "SELECT *, overtime.id AS otid, employees.employee_id AS empid FROM overtime, employees WHERE employees.id=overtime.employee_id AND (employees.branch_id = '$branch' or '0' = '$branch')  ORDER BY date_overtime DESC";
